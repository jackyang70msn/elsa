...
function ensureRepoElsaDir(repoPath) {
...
// --- Alias derivation ---
export function deriveAlias(repoPath, existing) {
...
// --- CRUD ---
export function addRepo(repoPath, alias) {
...
export function getRepoByAlias(alias) {
...
export function getRepoStateDir(repoPath) {
